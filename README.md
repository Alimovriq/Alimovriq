...
Я и Python: разрабатываю API для веб-приложений, занимаюсь автоматизацией и парсингом данных, создаю Django-приложения. Программирование — это не просто работа, а мое увлечение и кредо.
